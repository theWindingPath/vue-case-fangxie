      ...
      <div v-show="detailShow_show" class="detail">
        ...
        <div class="detail-wrapper clearfix">
          <div class="detail-main">
            ...
            <!-- flex小标题布局，title(line/text) -->
            <div class="title">
              <div class="line"></div>
              <div class="text">优惠信息</div>
              <div class="line"></div>
            </div>
            <!-- supports(ul)列表部分，supports-item(li)(icon($index)/text(span)) -->
            <ul v-if="maijia_shuju.supports" class="supports">
              <li v-for="item in maijia_shuju.supports" class="supports-item">
                <span class="icon" :class="classMap_shuzu[maijia_shuju.supports[$index].type]"></span>
                <span class="text">{{maijia_shuju.supports[$index].description}}</span>
              </li>
            </ul>
            <!-- 公告部分bulletin(text) -->
            <div class="bulletin">
              <p class="text">{{maijia_shuju.bulletin}}</p>
            </div>
          </div>
        </div>
          ...
          .supports
            ...
            .supports-item
              ...
              .icon
                ...
                background-repeat no-repeat
                &.decrease
                  bg-image-hanshu('decrease_2')
                &.discount
                  bg-image-hanshu('discount_2')
                &.guarantee
                  bg-image-hanshu('guarantee_2')
                &.invoice
                  bg-image-hanshu('invoice_2')
                &.special
                  bg-image-hanshu('special_2')
              .text
                line-height 16px
                font-size 12px
          .bulletin
